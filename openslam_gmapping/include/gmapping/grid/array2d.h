...
namespace GMapping
{
    ...
    protected:
        int m_xsize, m_ysize; /* 数组的大小 */
    };

    /**
     * @brief 创建二维数组
     *
     * @param xsize 二维数组行大小x
     * @param ysize 二维数组列大小y
     */
     ...
     * @brief 二维数组尺寸调整函数
     *
     * @param xmin 二维数组x向初始最小值
     * @param ymin 二维数组y向初始最小值
     * @param xmax 二维数组x向初始最大值
     * @param ymax 二维数组y向初始最大值
     */
    template <class Cell, const bool debug>
